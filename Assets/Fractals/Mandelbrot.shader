Shader "Fractal/Mandelbrot"
{
    Properties
    {
        ...
        _Exposure("Exposure", Color) = (0, 0, 0, 0)
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                col.rgb = float3(0.5 * sin(iter) + 0.5 * gradient * intensity, 0.5 * cos(iter) + 0.5 * gradient * intensity, 0.5 * sin(iter*3.0) + 0.5 * gradient * intensity)*_Exposure;
